...
public class TileMap {
	...
	public TileMap(int tileSize) {
		...
		numRowsToDraw = GamePanel.getHEIGHT() / tileSize + 2;
		numColsToDraw = GamePanel.getWIDTH() / tileSize + 2;
		tween = 0.07;
	}
	...
	public void loadMap(String s) {
		...
		try {
			...
			InputStream in = new File(s).toURI().toURL().openStream();
			assert in != null;
			...
			xmin = GamePanel.getWIDTH() - width;
			xmax = 0;
			ymin = GamePanel.getHEIGHT() - height;
			ymax = 0;
